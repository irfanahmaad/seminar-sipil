...
<div class="tp-banner-container">
  ...
  <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
          ...
          <!-- <img src="{{ asset('img/banner/banner-test.jpg') }}"  alt="slider streaming"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat" width="100%"> -->
            ...
            data-splitin="words"
            data-splitout="words"
            data-elementdelay="0.32"
            data-endelementdelay="0.32"
            data-endspeed="300"
          ...
          <div class="tp-caption medium_white_light_italic randomrotate customout tp-resizeme title_banner"
            ...
            data-endspeed="500"
            style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap; font-size: 48px;font-family: 'BentonSans Bold', sans-serif;">SEMINAR NASIONAL TEKNIK SIPIL 2018
          </div>
          <div class="tp-caption large_bold_white customin ltl"
            ...
            style="z-index: 7"><img src="{{ asset('img/logo/logo-pnj.png') }}" alt="radio" width="100px">
          </div>
        </li>
        ...
        <!-- <li data-transition="fade" data-slotamount="7" data-masterspeed="500"> -->
          <!-- MAIN IMAGE -->
          <!-- <img src="{{ asset('img/banner/banner.jpg') }}"  alt="slider Tahun Baru 2017"  data-bgfit="cover" data-bgposition="center" data-bgrepeat="no-repeat" /> -->
        <!-- </li> -->
